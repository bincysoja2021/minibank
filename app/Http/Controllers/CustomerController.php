...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $cust_list=User::with(['transactions','latestTransaction'])->orderBy('id','desc')->get();
        }
        else
        {
            $cust_list=User::where('id',$loggid)->with(['transactions','latestTransaction'])->orderBy('id','desc')->get();
        }
    ...
    public function history_transactions(Request $req)
    {
       ...
       $balance_amount=Transaction::where('cust_id',$cust_list->id)->orderBy('id','DESC')->latest()->first();
